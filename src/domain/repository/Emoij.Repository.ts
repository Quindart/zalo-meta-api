import { EMOJI } from "../../constants/index.ts";
import Emoji from "../../infrastructure/mongo/model/Emoji.ts";
    ...
    async deleteMyEmoji(messageId, userId) {
        try {
            ...
            if (!message) {
                ...
                message.emojis = message.emojis.filter((emoji: any) => emoji.userId !== userId);
                await message.save();
            }
