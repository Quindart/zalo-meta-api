...
class QRService {
    ...
    async generateQR(inputString, options = {}) {
    ...
    async renderQRToDOM(inputString, elementId, options = {}, logoPath = null) {
        if (typeof document === "undefined") {
            throw new Error("Phương thức này chỉ hoạt động trong trình duyệt.");
        }
        const url = await this.generateQR(inputString, options, logoPath);
