...
let EmojiService = class EmojiService {
    ...
    addEmoji(messageId, emoji, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.repository.addEmoji(messageId, emoji, userId);
        });
    }
    deleteMyEmoji(messageId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.repository.deleteMyEmoji(messageId, userId);
        });
    }
    getAllEmojiOfMessage(messageId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.repository.getAllEmojiOfMessage(messageId);
        });
    }
};
...
exports.EmojiService = EmojiService = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(type_1.default.EmojiRepository)),
